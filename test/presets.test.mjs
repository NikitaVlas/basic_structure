...
test("preset inheritance resolves deterministic catalog and semantic constraints", async () => {
  ...
  assert.deepEqual(presets.map((preset) => preset.id), ["backend-service", "documentation", "frontend-app", "fullstack-complete", "fullstack-minimal", "landing-minimal", "node-library", "production", "saas", "security-hardened", "seo-business"]);
