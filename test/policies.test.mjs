...
test("policy catalog is deterministic and documentation project is compliant", async () => {
  assert.deepEqual((await listPolicies(root)).map((policy) => policy.id), ["ai-harness-readiness", "documentation-baseline", "production-readiness", "security-baseline", "verification-baseline"]);
